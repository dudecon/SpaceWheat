...
func inject_emoji(emoji: String, icon, initial_amplitude = null) -> bool:
	# icon: Icon type, initial_amplitude: Complex or null (defaults to zero)
...
func get_amplitude(emoji: String) :
