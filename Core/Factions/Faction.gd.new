...
## {emoji: {inverts: bool, invert_target: String}}
## If inverts=true, measuring this emoji collapses it to invert_target instead
## Use for quantum-resistant refugees, unmeasurable states, etc.
