...
qii_token "S.QIIQC" "script"
qii_token "G3.Q" "explore"
qii_token "G3.E" "measure"
qii_token "G3.R" "reap"
qii_token "G1.E" "hadamard"
...
set +e
{
  ...
  echo "Command: godot --headless --path . --script Tests/qii_quantum_computer_probe.gd"
  echo
  godot --headless --path . --script Tests/qii_quantum_computer_probe.gd
} 2>&1 | tee "$log_file"
status=${PIPESTATUS[0]}
set -e
